...
export default function Page() {
    ...
    const profileComplete = user.publicMetadata?.complete;
              ...
              }
              {
                (
                  ...
                  (
                    !profileComplete
                    ?
                      <Button size="lg" variant="solid" color="warning" className="w-full text-large mt-2" as={Link} href="/profile" startContent={<AccountCircleOutlinedIcon />}>Complete Your Profile</Button>
                    :
                      <div className="flex flex-col mt-2 gap-2">
                        <Button size="lg" variant="solid" color="secondary" className="w-full text-large" as={Link} href="/applications" startContent={<WorkOutlineOutlinedIcon />}>Applications</Button>
                      </div>
                  )
                )
              }
