  ...
  return (
    <section className="flex flex-col box-border h-screen">
        ...
        {activeTab === "start" ? (
          <div className="flex items-center justify-center">
            <div className="flex flex-col gap-3 p-6 bg-default-50 rounded-medium border-1">
              <div className="flex flex-col gap-2 py-2">
                <h2 className="text-3xl text-center text-default-900">
                  Let&apos;s Setup Purple Squirrel!
                </h2>
                <h2 className="text-lg text-center text-default-600">
                  We will setup open positions and accepted application methods.
                </h2>
              </div>
          ...
          <div className="bg-default-50 rounded-medium px-unit-2 py-unit-3 h-full flex flex-col border-1">
            <div className="flex items-center justify-between gap-2 pl-unit-1 text-default-900">
              <Button
                ...
                size="md"
                radius="md"
                startContent={<WestOutlinedIcon />}
                onPress={() => setActiveTab("start")}
              >
                Start
              </Button>
              <h2>
                Setup open positions here. You can change them later at Admin
                Dashboard.
              </h2>
              <Button
                color="primary"
          ...
          <div className="bg-default-50 rounded-medium px-unit-2 py-unit-3 h-full flex flex-col border-1">
            <div className="flex items-center justify-between gap-2 pl-unit-1 text-default-900">
              ...
              <div>
                <h2>
                  Setup your application methods and mail inbox listening
                  schedule here. You can change it later at Admin Dashboard.
                </h2>
              </div>
              <Button
                isDisabled={!methodSaved}
                color={!methodSaved ? "default" : "success"}
                size="md"
                radius="md"
                endContent={<EastOutlinedIcon />}
                onPress={async () => {
          ...
          <div className="flex items-center justify-center">
            <div className="flex flex-col gap-3 p-6 bg-default-50 rounded-medium border-1">
              <div className="flex flex-col gap-2 py-2">
                ...
                <h2 className="text-lg text-center text-default-600">
                  Applicants from unread mails will appear shortly.
                </h2>
              </div>
              <div className="flex flex-col mt-2 gap-2">
                <Button
                  ...
                  as={Link}
                  href="/console"
                  startContent={<TerminalOutlinedIcon />}
                >
                  Recruiter Console
                </Button>
                <Button
                  ...
                  as={Link}
                  href="/dashboard"
                  startContent={<AdminPanelSettingsOutlinedIcon />}
                >
                  Admin Dashboard
                </Button>
              </div>
      ...
      <div className="flex-auto px-unit-4 pb-unit-4">
        {activeTab === "start" ? null : activeTab === "positions" ? (
