import { ApplicantRow, NextUIColor, ConsoleTab, SetupTab, DashboardTab, QueryTerminalSettingsTab, ApplicantStatus, CountryCode, PositionStatus, Scheduling, Role } from './index';
import { applicantRowSchema, nextUIColorSchema, consoleTabSchema, setupTabSchema, dashboardTabSchema, queryTerminalSettingsTabSchema, applicantStatusSchema, countryCodeSchema, positionStatusSchema, schedulingSchema, roleSchema } from './schemas';
...
export const isQueryTerminalSettingsTab = (data: any): data is QueryTerminalSettingsTab => {
