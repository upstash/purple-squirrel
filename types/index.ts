import { COUNTRY_CODES, APPLICANT_STATUS_OPTIONS, NEXTUI_COLORS, CONSOLE_TABS, DASHBOARD_TABS, SETUP_TABS, QUERY_TERMINAL_SETTINGS_TABS, POSITION_STATUS_OPTIONS, SCHEDULING_INTERVAL_OPTIONS, ROLES } from '@/app/constants';
...
export type Applicant = {
  id: string;
} & ApplicantData & ApplicantMetadata;
...
export type QueryTerminalSettingsTab = typeof QUERY_TERMINAL_SETTINGS_TABS[number];
